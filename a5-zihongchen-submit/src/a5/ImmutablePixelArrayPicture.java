...
public class ImmutablePixelArrayPicture extends PixelArrayPicture implements Picture {
 ...
 /*
  * (non-Javadoc)
  * @see a5.PixelArrayPicture#paint(int, int, a5.Pixel, double)
  * to overwrite paint method so that it does not change the internal status and return a new picture;
  * All other paint metod rely on this method
  */
	@Override
